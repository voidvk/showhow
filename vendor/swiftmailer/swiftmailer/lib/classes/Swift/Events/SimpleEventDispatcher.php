...
class Swift_Events_SimpleEventDispatcher implements Swift_Events_EventDispatcher
{
    ...
    /** Events listeners bound to this dispatcher */
    private $listeners = [];

    /** Listeners queued to have an Events bubbled up the stack to them */
    private $bubbleQueue = [];
    ...
    /**
     * Dispatch the given Events to all suitable listeners.
     *
